...
class DomainHasReachableRemoteGatewaysWrapped(DomainHasReachableRemoteGateways):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainHasReachableRemoteGatewaysWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainHasReachableRemoteGatewaysWrapped:
        """Create an instance of DomainHasReachableRemoteGatewaysWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DomainHasReachableRemoteGatewaysWrapped.parse_obj(obj)

        _obj = DomainHasReachableRemoteGatewaysWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": DomainHasReachableRemoteGatewaysData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
