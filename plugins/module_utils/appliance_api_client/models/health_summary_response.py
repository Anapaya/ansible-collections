...
class HealthSummaryResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HealthSummaryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HealthSummaryResponse:
        """Create an instance of HealthSummaryResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HealthSummaryResponse.parse_obj(obj)

        _obj = HealthSummaryResponse.parse_obj({
            "health": HealthSummary.from_dict(obj.get("health")) if obj.get("health") is not None else None
        })
        return _obj
