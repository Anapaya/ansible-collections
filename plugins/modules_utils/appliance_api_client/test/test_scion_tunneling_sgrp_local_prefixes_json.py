    ...
    def make_instance(self, include_optional) -> ScionTunnelingSGRPLocalPrefixesJSON:
        ...
        if include_optional:
            return ScionTunnelingSGRPLocalPrefixesJSON(
                local_prefixes = openapi_client.models.scion_tunneling_sgrp_local_prefixes.ScionTunnelingSGRPLocalPrefixes(
                    static = openapi_client.models.scion_tunneling_sgrp_local_prefixes_static.ScionTunnelingSGRPLocalPrefixesStatic(
                        prefixes = [
                            ''
                            ], ), 
                    static_probed = [
                        openapi_client.models.scion_tunneling_sgrp_local_prefixes_static_probed.ScionTunnelingSGRPLocalPrefixesStaticProbed(
                            next_hop = '', 
                            reachable = True, 
                            last_success = '', 
                            prefixes = [
                    ...
                    bgp = openapi_client.models.scion_tunneling_sgrp_local_prefixes_bgp.ScionTunnelingSGRPLocalPrefixesBGP(
                        prefixes = , ), )
            )
        else:
            return ScionTunnelingSGRPLocalPrefixesJSON(
