...
class CertificateChainForASAvailableWrapped(CertificateChainForASAvailable):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateChainForASAvailableWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CertificateChainForASAvailableWrapped:
        """Create an instance of CertificateChainForASAvailableWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificateChainForASAvailableWrapped.parse_obj(obj)

        _obj = CertificateChainForASAvailableWrapped.parse_obj({
