    ...
    def make_instance(self, include_optional) -> ScionTunnelingSummary:
        ...
        if include_optional:
            return ScionTunnelingSummary(
                sessions = [
                    openapi_client.models.scion_tunneling_session.ScionTunnelingSession(
                        session_id = '', 
                        ...
                        encryption = 'disabled', 
                        paths = [
                            openapi_client.models.scion_tunneling_session_path.ScionTunnelingSessionPath(
                                fingerprint = '', 
                                current = True, 
                                rejected = True, )
                            ], )
                ...
                routing_chains = [
                    openapi_client.models.scion_tunneling_routing_chain.ScionTunnelingRoutingChain(
                        routing_chain_id = '', 
