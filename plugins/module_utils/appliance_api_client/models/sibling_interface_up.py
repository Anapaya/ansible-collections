...
class SiblingInterfaceUp(BaseHealthCheck):
    """
    Check data for an explanation of this health check.   # noqa: E501
    """
    data: SiblingInterfaceUpData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiblingInterfaceUp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiblingInterfaceUp:
