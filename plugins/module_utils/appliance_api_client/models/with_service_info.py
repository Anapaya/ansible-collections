...
class WithServiceInfo(BaseModel):
    """
    WithServiceInfo
    """
    ...
    __properties = ["component", "service_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WithServiceInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WithServiceInfo:
        """Create an instance of WithServiceInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WithServiceInfo.parse_obj(obj)

        _obj = WithServiceInfo.parse_obj({
