    ...
    def make_instance(self, include_optional) -> DomainTrafficPolicyHasPaths:
        ...
        if include_optional:
            return DomainTrafficPolicyHasPaths(
                data = openapi_client.models.domain_traffic_policy_has_paths_data.DomainTrafficPolicyHasPathsData(
                    domain = '', 
                    traffic_matcher = '', 
                    failover_sequence = [
                        openapi_client.models.domain_traffic_policy_failover_sequence.DomainTrafficPolicyFailoverSequence(
                            name = '', 
                            paths = 56, )
                        ], )
            )
