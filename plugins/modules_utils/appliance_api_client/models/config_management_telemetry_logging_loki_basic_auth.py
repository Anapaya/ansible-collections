...
class ConfigManagementTelemetryLoggingLokiBasicAuth(BaseModel):
    ...
    """ # noqa: E501
    password: Optional[StrictStr] = Field(default=None, description="The password to use for basic auth.")
    username: Optional[StrictStr] = Field(default=None, description="The username to use for basic auth.")
