...
class TestConfigScionTunnelingDomainTrafficPolicyFailoverSequenceEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigScionTunnelingDomainTrafficPolicyFailoverSequenceEntry:
        """Test ConfigScionTunnelingDomainTrafficPolicyFailoverSequenceEntry
    ...
    def testConfigScionTunnelingDomainTrafficPolicyFailoverSequenceEntry(self):
        """Test ConfigScionTunnelingDomainTrafficPolicyFailoverSequenceEntry"""
