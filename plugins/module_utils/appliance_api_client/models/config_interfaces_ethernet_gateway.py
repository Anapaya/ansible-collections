...
class ConfigInterfacesEthernetGateway(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesEthernetGateway:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesEthernetGateway:
        """Create an instance of ConfigInterfacesEthernetGateway from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesEthernetGateway.parse_obj(obj)

        _obj = ConfigInterfacesEthernetGateway.parse_obj({
