...
class TracerouteRun(BaseModel):
    ...
    probes_per_hop: Optional[StrictInt] = Field(3, description="Number of probes per hop")
    __properties = ["destination_host", "destination_isd_as", "source_isd_as", "sequence", "timeout", "probes_per_hop"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TracerouteRun:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TracerouteRun:
        """Create an instance of TracerouteRun from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TracerouteRun.parse_obj(obj)

        _obj = TracerouteRun.parse_obj({
