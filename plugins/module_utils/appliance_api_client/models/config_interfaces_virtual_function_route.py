...
class ConfigInterfacesVirtualFunctionRoute(BaseModel):
    ...
    metric: Optional[StrictInt] = Field(default=0, description="The metric for the route. The lower its value, the higher its priority.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "metric": obj.get("metric") if obj.get("metric") is not None else 0,
