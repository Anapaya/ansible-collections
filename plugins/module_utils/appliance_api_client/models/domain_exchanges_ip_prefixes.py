...
class DomainExchangesIPPrefixes(BaseHealthCheck):
    """
    DomainExchangesIPPrefixes
    """
    data: DomainExchangesIPPrefixesData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainExchangesIPPrefixes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainExchangesIPPrefixes:
