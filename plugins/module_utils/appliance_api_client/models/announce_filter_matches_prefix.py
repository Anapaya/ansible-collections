...
class AnnounceFilterMatchesPrefix(BaseHealthCheck):
    """
    AnnounceFilterMatchesPrefix
    """
    data: AnnounceFilterMatchesPrefixData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnounceFilterMatchesPrefix:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnounceFilterMatchesPrefix:
