...
class SoftwarePackagesPostResponseJson(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwarePackagesPostResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SoftwarePackagesPostResponseJson:
        """Create an instance of SoftwarePackagesPostResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwarePackagesPostResponseJson.parse_obj(obj)

        _obj = SoftwarePackagesPostResponseJson.parse_obj({
