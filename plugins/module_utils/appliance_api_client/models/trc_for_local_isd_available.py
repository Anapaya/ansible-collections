...
class TRCForLocalISDAvailable(BaseHealthCheck):
    """
    Check data for an explanation of this health check.   # noqa: E501
    """
    data: TRCForLocalISDAvailableData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TRCForLocalISDAvailable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TRCForLocalISDAvailable:
