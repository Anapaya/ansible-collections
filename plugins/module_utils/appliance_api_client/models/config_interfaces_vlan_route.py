...
class ConfigInterfacesVlanRoute(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVlanRoute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVlanRoute:
        """Create an instance of ConfigInterfacesVlanRoute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVlanRoute.parse_obj(obj)

        _obj = ConfigInterfacesVlanRoute.parse_obj({
