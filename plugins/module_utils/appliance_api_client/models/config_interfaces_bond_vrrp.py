...
class ConfigInterfacesBondVrrp(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesBondVrrp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesBondVrrp:
        """Create an instance of ConfigInterfacesBondVrrp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesBondVrrp.parse_obj(obj)

        _obj = ConfigInterfacesBondVrrp.parse_obj({
