...
class CertificateChainForASAvailable(BaseHealthCheck):
    ...
    """
    data: CertificateChainForASAvailableData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificateChainForASAvailable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CertificateChainForASAvailable:
