...
class TierMapping(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pro
        if self.pro:
            _dict['pro'] = self.pro.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "legacy": ProductTierFeatures.from_dict(obj.get("legacy")) if obj.get("legacy") is not None else None
        })
        return _obj
