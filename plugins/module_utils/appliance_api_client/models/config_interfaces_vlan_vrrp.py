...
class ConfigInterfacesVlanVrrp(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVlanVrrp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVlanVrrp:
        """Create an instance of ConfigInterfacesVlanVrrp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVlanVrrp.parse_obj(obj)

        _obj = ConfigInterfacesVlanVrrp.parse_obj({
