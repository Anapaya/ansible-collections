...
class DomainHasPathsToRemote(BaseHealthCheck):
    """
    DomainHasPathsToRemote
    """
    data: DomainHasPathsToRemoteData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainHasPathsToRemote:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainHasPathsToRemote:
