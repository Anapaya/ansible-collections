...
class DomainTrafficPolicyHasPaths(BaseHealthCheck):
    """
    DomainTrafficPolicyHasPaths
    """
    data: DomainTrafficPolicyHasPathsData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainTrafficPolicyHasPaths:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainTrafficPolicyHasPaths:
