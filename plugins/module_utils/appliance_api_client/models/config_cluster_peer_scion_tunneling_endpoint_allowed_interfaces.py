...
class ConfigClusterPeerScionTunnelingEndpointAllowedInterfaces(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigClusterPeerScionTunnelingEndpointAllowedInterfaces:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigClusterPeerScionTunnelingEndpointAllowedInterfaces:
        """Create an instance of ConfigClusterPeerScionTunnelingEndpointAllowedInterfaces from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigClusterPeerScionTunnelingEndpointAllowedInterfaces.parse_obj(obj)

        _obj = ConfigClusterPeerScionTunnelingEndpointAllowedInterfaces.parse_obj({
