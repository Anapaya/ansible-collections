...
class ConfigScionTunnelingDomainPrefixesAcceptFilterEntry(BaseModel):
    """
    List of prefix matchers. Prefixes that are announced by remotes are filtered by the prefix matchers in order by accepting all IPs that are in _accepted_ matchers and rejecting ones that are in _rejected_ prefix matchers.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigScionTunnelingDomainPrefixesAcceptFilterEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigScionTunnelingDomainPrefixesAcceptFilterEntry:
        """Create an instance of ConfigScionTunnelingDomainPrefixesAcceptFilterEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigScionTunnelingDomainPrefixesAcceptFilterEntry.parse_obj(obj)

        _obj = ConfigScionTunnelingDomainPrefixesAcceptFilterEntry.parse_obj({
