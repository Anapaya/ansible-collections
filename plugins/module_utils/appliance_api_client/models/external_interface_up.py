...
class ExternalInterfaceUp(BaseHealthCheck):
    """
    Check data for an explanation of this health check.   # noqa: E501
    """
    data: ExternalInterfaceUpData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalInterfaceUp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalInterfaceUp:
