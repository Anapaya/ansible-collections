...
class TRC(BaseModel):
    ...
    id: TRCID
    validity: Validity
    core_ases: List[Annotated[str, Field(strict=True)]]
    authoritative_ases: List[Annotated[str, Field(strict=True)]]
    description: StrictStr
    blob: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "validity", "core_ases", "authoritative_ases", "description", "blob"]
