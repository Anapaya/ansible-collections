...
class CppkiTrcsPostResponseJson(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CppkiTrcsPostResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CppkiTrcsPostResponseJson:
        """Create an instance of CppkiTrcsPostResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CppkiTrcsPostResponseJson.parse_obj(obj)

        _obj = CppkiTrcsPostResponseJson.parse_obj({
            "trc": TRC.from_dict(obj.get("trc")) if obj.get("trc") is not None else None
        })
        return _obj
