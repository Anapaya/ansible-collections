...
class SiblingInterfaceUpWrapped(SiblingInterfaceUp):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiblingInterfaceUpWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiblingInterfaceUpWrapped:
        """Create an instance of SiblingInterfaceUpWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SiblingInterfaceUpWrapped.parse_obj(obj)

        _obj = SiblingInterfaceUpWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": SiblingInterfaceUpData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
