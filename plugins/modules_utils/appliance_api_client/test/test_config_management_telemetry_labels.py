...
class TestConfigManagementTelemetryLabels(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigManagementTelemetryLabels:
        """Test ConfigManagementTelemetryLabels
    ...
    def testConfigManagementTelemetryLabels(self):
        """Test ConfigManagementTelemetryLabels"""
