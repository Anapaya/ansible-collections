...
class AcceptFilterMatchesPrefixWrapped(AcceptFilterMatchesPrefix):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AcceptFilterMatchesPrefixWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AcceptFilterMatchesPrefixWrapped:
        """Create an instance of AcceptFilterMatchesPrefixWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AcceptFilterMatchesPrefixWrapped.parse_obj(obj)

        _obj = AcceptFilterMatchesPrefixWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": AcceptFilterMatchesPrefixData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
