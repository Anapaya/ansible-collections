...
class SoftwarePackageDeleteResponseJson(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SoftwarePackageDeleteResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SoftwarePackageDeleteResponseJson:
        """Create an instance of SoftwarePackageDeleteResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SoftwarePackageDeleteResponseJson.parse_obj(obj)

        _obj = SoftwarePackageDeleteResponseJson.parse_obj({
