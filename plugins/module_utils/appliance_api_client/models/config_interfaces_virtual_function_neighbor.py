...
class ConfigInterfacesVirtualFunctionNeighbor(BaseModel):
    """
    List of neighbors configured on this interface.
    """ # noqa: E501
    address: StrictStr = Field(description="The IP address.")
    comment: Optional[StrictStr] = Field(default=None, description="An optional human-readable string to comment on this neighbor.")
    mac: Optional[StrictStr] = Field(default=None, description="The MAC address corresponding to the address. It is of the form `XX:XX:XX:XX:XX:XX`.")
    sequence_id: StrictInt = Field(description="The sequence id determines the order of the neighbor entries.")
    __properties: ClassVar[List[str]] = ["address", "comment", "mac", "sequence_id"]
