...
class DomainTrafficPolicyHasPathsWrapped(DomainTrafficPolicyHasPaths):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainTrafficPolicyHasPathsWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainTrafficPolicyHasPathsWrapped:
        """Create an instance of DomainTrafficPolicyHasPathsWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DomainTrafficPolicyHasPathsWrapped.parse_obj(obj)

        _obj = DomainTrafficPolicyHasPathsWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": DomainTrafficPolicyHasPathsData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
