...
class ConfigClusterPeerScionASNeighbor(BaseModel):
    ...
    """
    interfaces: Optional[conlist(ConfigClusterPeerScionASNeighborInterface)] = Field(None, description="The list of interfaces on the peer for this neighbor AS.")
    ...
    __properties = ["interfaces", "neighbor_isd_as", "relationship"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigClusterPeerScionASNeighbor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigClusterPeerScionASNeighbor:
        """Create an instance of ConfigClusterPeerScionASNeighbor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigClusterPeerScionASNeighbor.parse_obj(obj)

        _obj = ConfigClusterPeerScionASNeighbor.parse_obj({
