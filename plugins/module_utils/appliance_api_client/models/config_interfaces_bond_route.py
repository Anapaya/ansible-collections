...
class ConfigInterfacesBondRoute(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesBondRoute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesBondRoute:
        """Create an instance of ConfigInterfacesBondRoute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesBondRoute.parse_obj(obj)

        _obj = ConfigInterfacesBondRoute.parse_obj({
