...
class TestTunnelingFeatures(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TunnelingFeatures:
        """Test TunnelingFeatures
        ...
        if include_optional:
            return TunnelingFeatures(
                ...
                max_remotes = None,
                max_path_filters = None,
                max_traffic_matchers = None
            )
        else:
            return TunnelingFeatures(
        )
    ...
    def testTunnelingFeatures(self):
        """Test TunnelingFeatures"""
