...
class Certificate(BaseModel):
    ...
    Certificate
    """ # noqa: E501
    distinguished_name: StrictStr
    isd_as: Annotated[str, Field(strict=True)]
    validity: Validity
    subject_key_algo: StrictStr
    subject_key_id: StrictStr
    __properties: ClassVar[List[str]] = ["distinguished_name", "isd_as", "validity", "subject_key_algo", "subject_key_id"]
