...
class ConfigSCIONASCAServiceAnapayaVault(BaseModel):
    ...
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = Field(default=None, description="The list of addresses where the Anapaya Vault backend can be reached. This list must be non-empty.")
    ...
    __properties: ClassVar[List[str]] = ["addresses", "credentials", "validation"]
