...
class ScionTunnelingDiscoverySession(BaseModel):
    ...
    peers: List[ScionTunnelingDiscoveryPeer] = Field(description="The list of peers announced by the remote ISD-AS.")
    last_success: Optional[StrictStr] = Field(default=None, description="The last time when the list of peers was fetched successfully.", alias="last-success")
    error: Optional[StrictStr] = Field(default=None, description="Error from the last discovery request. If the last request was successful it is not filled in. ")
    __properties: ClassVar[List[str]] = ["local-isd-as", "remote-isd-as", "path", "peers", "last-success", "error"]
