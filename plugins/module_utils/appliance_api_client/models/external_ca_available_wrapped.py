...
class ExternalCAAvailableWrapped(ExternalCAAvailable):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalCAAvailableWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalCAAvailableWrapped:
        """Create an instance of ExternalCAAvailableWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalCAAvailableWrapped.parse_obj(obj)

        _obj = ExternalCAAvailableWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": ExternalCAAvailableData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
