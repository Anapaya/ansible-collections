            ...
            return ConfigInterfaces(
                ...
                virtual_functions = [
                    openapi_client.models.config_interfaces_virtual_function.Config_Interfaces_VirtualFunction(
                        ...
                        gateway = openapi_client.models.config_interfaces_virtual_function_gateway.Config_Interfaces_VirtualFunction_Gateway(
                            ipv4_gateway = '', 
                            ipv6_gateway = '', ), 
                        link = '', 
                        mac = '', 
                        ...
                        name = '', 
                        neighbors = [
                            openapi_client.models.config_interfaces_virtual_function_neighbor.Config_Interfaces_VirtualFunction_Neighbor(
                                address = '', 
                                comment = '', 
                                mac = '', 
                                sequence_id = 3, )
                        ...
                        routes = [
                            openapi_client.models.config_interfaces_virtual_function_route.Config_Interfaces_VirtualFunction_Route(
                                comment = '', 
                                from = '', 
                                metric = 56, 
                                sequence_id = 3, 
                        ...
                        tx_queue_size = 2048, 
                        vrrp = [
                            openapi_client.models.config_interfaces_virtual_function_vrrp.Config_Interfaces_VirtualFunction_Vrrp(
                                addresses = [
                                    ''
                                    ], 
                                no_preempt = True, 
                ...
                vlans = [
                    openapi_client.models.config_interfaces_vlan.Config_Interfaces_Vlan(
                        ...
                        gateway = openapi_client.models.config_interfaces_vlan_gateway.Config_Interfaces_Vlan_Gateway(
                            ipv4_gateway = '', 
                            ipv6_gateway = '', ), 
                        id = 56, 
                        link = '', 
                        ...
                        name = '', 
                        neighbors = [
                            openapi_client.models.config_interfaces_vlan_neighbor.Config_Interfaces_Vlan_Neighbor(
                                address = '', 
                                comment = '', 
                                mac = '', 
                                sequence_id = 3, )
                        ...
                        routes = [
                            openapi_client.models.config_interfaces_vlan_route.Config_Interfaces_Vlan_Route(
                                comment = '', 
                                from = '', 
                                metric = 56, 
                                sequence_id = 3, 
                        ...
                        tx_queue_size = 2048, 
                        vrrp = [
                            openapi_client.models.config_interfaces_vlan_vrrp.Config_Interfaces_Vlan_Vrrp(
                                addresses = [
                                    ''
                                    ], 
                                no_preempt = True, 
                ...
                wireguards = [
                    openapi_client.models.config_interfaces_wireguard.Config_Interfaces_Wireguard(
                        ...
                        gateway = openapi_client.models.config_interfaces_wireguard_gateway.Config_Interfaces_Wireguard_Gateway(
                            ipv4_gateway = '', 
                            ipv6_gateway = '', ), 
                        mtu = 56, 
                        name = '', 
                        peers = [
                            openapi_client.models.config_interfaces_wireguard_peer.Config_Interfaces_Wireguard_Peer(
                                allowed_ips = [
                                    ''
                                    ], 
                                endpoint = '', 
                        ...
                        port = 56, 
                        routes = [
                            openapi_client.models.config_interfaces_wireguard_route.Config_Interfaces_Wireguard_Route(
                                comment = '', 
                                from = '', 
                                metric = 56, 
                                sequence_id = 3, 
