...
class ConfigGetResponseJson(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigGetResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigGetResponseJson:
        """Create an instance of ConfigGetResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigGetResponseJson.parse_obj(obj)

        _obj = ConfigGetResponseJson.parse_obj({
