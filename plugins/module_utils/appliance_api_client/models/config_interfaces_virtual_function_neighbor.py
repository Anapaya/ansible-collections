...
class ConfigInterfacesVirtualFunctionNeighbor(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVirtualFunctionNeighbor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVirtualFunctionNeighbor:
        """Create an instance of ConfigInterfacesVirtualFunctionNeighbor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVirtualFunctionNeighbor.parse_obj(obj)

        _obj = ConfigInterfacesVirtualFunctionNeighbor.parse_obj({
