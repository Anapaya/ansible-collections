...
class ConfigInterfacesBondNeighbor(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesBondNeighbor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesBondNeighbor:
        """Create an instance of ConfigInterfacesBondNeighbor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesBondNeighbor.parse_obj(obj)

        _obj = ConfigInterfacesBondNeighbor.parse_obj({
