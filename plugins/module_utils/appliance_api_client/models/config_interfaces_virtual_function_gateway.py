...
class ConfigInterfacesVirtualFunctionGateway(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVirtualFunctionGateway:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVirtualFunctionGateway:
        """Create an instance of ConfigInterfacesVirtualFunctionGateway from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVirtualFunctionGateway.parse_obj(obj)

        _obj = ConfigInterfacesVirtualFunctionGateway.parse_obj({
