...
class Health(BaseModel):
    ...
    """
    status: Status = Field(...)
    checks: conlist(Check) = Field(..., description="List of health checks.")
    ...
    def from_dict(cls, obj: dict) -> Health:
        ...
        _obj = Health.parse_obj({
            ...
            "checks": [Check.from_dict(_item) for _item in obj.get("checks")] if obj.get("checks") is not None else None
        })
        return _obj
