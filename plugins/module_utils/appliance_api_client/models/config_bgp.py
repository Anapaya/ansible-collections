...
class ConfigBgp(BaseModel):
    ...
    """ # noqa: E501
    var_global: Optional[ConfigBgpGlobal] = Field(default=None, alias="global")
    neighbors: Optional[List[ConfigBgpNeighbor]] = Field(default=None, description="Configuration for BGP neighbors")
    __properties: ClassVar[List[str]] = ["global", "neighbors"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "global": ConfigBgpGlobal.from_dict(obj.get("global")) if obj.get("global") is not None else None,
