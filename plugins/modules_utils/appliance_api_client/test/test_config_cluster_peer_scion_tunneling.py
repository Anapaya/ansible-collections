...
class TestConfigClusterPeerScionTunneling(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigClusterPeerScionTunneling:
        """Test ConfigClusterPeerScionTunneling
    ...
    def testConfigClusterPeerScionTunneling(self):
        """Test ConfigClusterPeerScionTunneling"""
