...
class ConfigInterfacesBondGateway(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesBondGateway:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesBondGateway:
        """Create an instance of ConfigInterfacesBondGateway from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesBondGateway.parse_obj(obj)

        _obj = ConfigInterfacesBondGateway.parse_obj({
