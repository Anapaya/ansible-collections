...
class ConfigPutResponseJson(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigPutResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigPutResponseJson:
        """Create an instance of ConfigPutResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigPutResponseJson.parse_obj(obj)

        _obj = ConfigPutResponseJson.parse_obj({
