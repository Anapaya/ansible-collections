...
class DomainHasReachableRemoteGateways(BaseHealthCheck):
    """
    DomainHasReachableRemoteGateways
    """
    data: DomainHasReachableRemoteGatewaysData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DomainHasReachableRemoteGateways:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DomainHasReachableRemoteGateways:
