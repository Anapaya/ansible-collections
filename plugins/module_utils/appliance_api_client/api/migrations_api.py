...
class MigrationsApi:
    ...
    @validate_call
    def migrations_config_get(
        self,
        version: Annotated[StrictStr, Field(description="Version of the appliance for which the configuration is.")],
        ...
        _param = self._migrations_config_get_serialize(
            version=version,
    ...
    @validate_call
    def migrations_config_get_with_http_info(
        self,
        version: Annotated[StrictStr, Field(description="Version of the appliance for which the configuration is.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def migrations_config_get_without_preload_content(
        self,
        version: Annotated[StrictStr, Field(description="Version of the appliance for which the configuration is.")],
        _request_timeout: Union[
            None,
    ...
    def _migrations_config_get_serialize(
        self,
        version,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/migrations/{version}/config',
    ...
    def migrations_config_put(
        ...
        _param = self._migrations_config_put_serialize(
            version=version,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def migrations_config_put_with_http_info(
        self,
        version: Annotated[StrictStr, Field(description="Version of the appliance for which the configuration is.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def migrations_config_put_without_preload_content(
        self,
        version: Annotated[StrictStr, Field(description="Version of the appliance for which the configuration is.")],
        _request_timeout: Union[
            None,
    ...
    def _migrations_config_put_serialize(
        self,
        version,
        _request_auth,
        _content_type,
