...
class AcceptFilterMatchesPrefix(BaseHealthCheck):
    """
    Check data for an explanation of this health check.   # noqa: E501
    """
    data: AcceptFilterMatchesPrefixData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AcceptFilterMatchesPrefix:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AcceptFilterMatchesPrefix:
