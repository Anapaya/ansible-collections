...
class ConfigInterfacesVlanNeighbor(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVlanNeighbor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVlanNeighbor:
        """Create an instance of ConfigInterfacesVlanNeighbor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVlanNeighbor.parse_obj(obj)

        _obj = ConfigInterfacesVlanNeighbor.parse_obj({
