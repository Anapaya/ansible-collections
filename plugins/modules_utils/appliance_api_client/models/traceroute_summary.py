...
class TracerouteSummary(BaseModel):
    ...
    """ # noqa: E501
    path: Path
    hops: Optional[List[TracerouteHopInfo]] = Field(default=None, description="Information and statistics for each SCION path hop.")
    __properties: ClassVar[List[str]] = ["path", "hops"]
