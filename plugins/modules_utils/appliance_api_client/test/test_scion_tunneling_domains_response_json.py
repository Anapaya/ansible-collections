    ...
    def make_instance(self, include_optional) -> ScionTunnelingDomainsResponseJson:
        ...
        if include_optional:
            return ScionTunnelingDomainsResponseJson(
                domains = [
                    openapi_client.models.scion_tunneling_domain_config.ScionTunnelingDomainConfig(
                        domain_name = '', 
                        default = True, 
                        encryption = 'disabled', 
                        local_isd_ases = [
                        ...
                        remote_isd_ases = [
                            openapi_client.models.scion_tunneling_isd_as_filter.ScionTunnelingIsdAsFilter(
                                action = 'ACCEPT', 
                                isd_as = '1-ff00:0:110', )
                            ], 
                        prefixes = openapi_client.models.scion_tunneling_domain_config_prefixes.ScionTunnelingDomainConfig_prefixes(
                            announce_filter = [
                        ...
                        traffic_policies = [
                            openapi_client.models.scion_tunneling_traffic_policy.ScionTunnelingTrafficPolicy(
                                traffic_matcher = '', 
                                failover_sequence = [
                                    ''
                                    ], )
