...
class TRCForLocalISDAvailableInDaemonWrapped(TRCForLocalISDAvailableInDaemon):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TRCForLocalISDAvailableInDaemonWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TRCForLocalISDAvailableInDaemonWrapped:
        """Create an instance of TRCForLocalISDAvailableInDaemonWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TRCForLocalISDAvailableInDaemonWrapped.parse_obj(obj)

        _obj = TRCForLocalISDAvailableInDaemonWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": TRCForLocalISDAvailableInDaemonData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
