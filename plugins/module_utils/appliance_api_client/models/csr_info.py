...
class CsrInfo(BaseModel):
    ...
    CsrInfo
    """
    subject: CertificateSubject = Field(...)
    creation_time: datetime = Field(...)
    id: StrictStr = Field(...)
    __properties = ["subject", "creation_time", "id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CsrInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CsrInfo:
        """Create an instance of CsrInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CsrInfo.parse_obj(obj)

        _obj = CsrInfo.parse_obj({
