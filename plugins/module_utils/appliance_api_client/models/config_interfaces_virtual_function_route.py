...
class ConfigInterfacesVirtualFunctionRoute(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVirtualFunctionRoute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVirtualFunctionRoute:
        """Create an instance of ConfigInterfacesVirtualFunctionRoute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVirtualFunctionRoute.parse_obj(obj)

        _obj = ConfigInterfacesVirtualFunctionRoute.parse_obj({
