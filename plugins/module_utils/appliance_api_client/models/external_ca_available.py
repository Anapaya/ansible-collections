...
class ExternalCAAvailable(BaseHealthCheck):
    """
    Check data for an explanation of this health check.   # noqa: E501
    """
    data: ExternalCAAvailableData = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalCAAvailable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalCAAvailable:
