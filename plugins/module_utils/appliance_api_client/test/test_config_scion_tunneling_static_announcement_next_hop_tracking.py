...
class TestConfigScionTunnelingStaticAnnouncementNextHopTracking(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigScionTunnelingStaticAnnouncementNextHopTracking:
        """Test ConfigScionTunnelingStaticAnnouncementNextHopTracking
    ...
    def testConfigScionTunnelingStaticAnnouncementNextHopTracking(self):
        """Test ConfigScionTunnelingStaticAnnouncementNextHopTracking"""
