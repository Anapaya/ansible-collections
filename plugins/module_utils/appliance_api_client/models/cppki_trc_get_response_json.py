...
class CppkiTrcGetResponseJson(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CppkiTrcGetResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CppkiTrcGetResponseJson:
        """Create an instance of CppkiTrcGetResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CppkiTrcGetResponseJson.parse_obj(obj)

        _obj = CppkiTrcGetResponseJson.parse_obj({
