...
class ConfigScionTunnelingDomainPrefixesAcceptFilterEntry(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="Optional description for the prefix matcher.")
    prefixes: Optional[List[StrictStr]] = Field(default=None, description="The list of IP prefixes used for matching. The matcher matches all IP prefixes that are contained in the union of the specified IP prefixes, i.e. it matches all listed prefixes as well as their contained more specific prefixes.")
    ...
    __properties: ClassVar[List[str]] = ["action", "description", "prefixes", "sequence_id"]
