                ...
                config = ansible.module_utils.appliance_api_client.models.config.Config(
                    advanced = ansible.module_utils.appliance_api_client.models.config_advanced.Config_Advanced(
                        service_customizations = [
                            ansible.module_utils.appliance_api_client.models.config_advanced_service_customizations.Config_Advanced_ServiceCustomizations(
                                disabled = True, 
