        ...
        if include_optional:
            return ConfigManagement(
                ...
                ssh = openapi_client.models.config_management_ssh.Config_Management_Ssh(
                    ...
                    users = [
                        openapi_client.models.config_management_ssh_user.Config_Management_Ssh_User(
                            ssh_keys = [
                                openapi_client.models.config_management_ssh_user_ssh_key.Config_Management_Ssh_User_SshKey(
                                    description = '', 
