...
class ToolsScionPingPostRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ToolsScionPingPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ToolsScionPingPostRequest:
        """Create an instance of ToolsScionPingPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ToolsScionPingPostRequest.parse_obj(obj)

        _obj = ToolsScionPingPostRequest.parse_obj({
            "run": PingRun.from_dict(obj.get("run")) if obj.get("run") is not None else None
        })
        return _obj
