...
class ConfigPutRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigPutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigPutRequest:
        """Create an instance of ConfigPutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigPutRequest.parse_obj(obj)

        _obj = ConfigPutRequest.parse_obj({
