...
class LanStatsGateway(BaseModel):
    ...
    __properties = ["probe_address", "local_isd_as", "alive", "latency", "jitter", "last_success_time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanStatsGateway:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanStatsGateway:
        """Create an instance of LanStatsGateway from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LanStatsGateway.parse_obj(obj)

        _obj = LanStatsGateway.parse_obj({
