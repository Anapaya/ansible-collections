...
class AnyDomainHasHealthyRemoteGatewaysWrapped(AnyDomainHasHealthyRemoteGateways):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnyDomainHasHealthyRemoteGatewaysWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnyDomainHasHealthyRemoteGatewaysWrapped:
        """Create an instance of AnyDomainHasHealthyRemoteGatewaysWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnyDomainHasHealthyRemoteGatewaysWrapped.parse_obj(obj)

        _obj = AnyDomainHasHealthyRemoteGatewaysWrapped.parse_obj({
