...
class HealthGetResponseJson(BaseModel):
    """
    HealthGetResponseJson
    """
    health: SchemasHealth = Field(...)
    __properties = ["health"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HealthGetResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HealthGetResponseJson:
        """Create an instance of HealthGetResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HealthGetResponseJson.parse_obj(obj)

        _obj = HealthGetResponseJson.parse_obj({
            "health": SchemasHealth.from_dict(obj.get("health")) if obj.get("health") is not None else None
        })
        return _obj
