...
class TRCForLocalISDAvailableWrapped(TRCForLocalISDAvailable):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TRCForLocalISDAvailableWrapped:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TRCForLocalISDAvailableWrapped:
        """Create an instance of TRCForLocalISDAvailableWrapped from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TRCForLocalISDAvailableWrapped.parse_obj(obj)

        _obj = TRCForLocalISDAvailableWrapped.parse_obj({
            "check_id": obj.get("check_id"),
            "name": obj.get("name"),
            "status": obj.get("status"),
            "detail": obj.get("detail"),
            "data": TRCForLocalISDAvailableData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
