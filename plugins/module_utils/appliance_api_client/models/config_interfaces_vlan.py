...
class ConfigInterfacesVlan(BaseModel):
    """
    List of VLAN interfaces.  # noqa: E501
    """
    ...
    id: conint(strict=True, le=4095) = Field(..., description="The VLAN ID of the VLAN interface. It ranges between 0 and 4095.")
    ...
    neighbors: Optional[conlist(ConfigInterfacesVlanNeighbor)] = Field(None, description="The static neighbors configured on this network interface.")
    routes: Optional[conlist(ConfigInterfacesVlanRoute)] = Field(None, description="The routes which are configured on this network interface.")
    ...
    vrrp: Optional[conlist(ConfigInterfacesVlanVrrp)] = Field(None, description="The VRRP (Virtual Router Redundancy Protocol) configurations for this interface.")
    __properties = ["accept_ra", "addresses", "gateway", "id", "link", "mac", "mtu", "name", "neighbors", "routes", "rx_queue_size", "tx_queue_size", "vrrp"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesVlan:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesVlan:
        """Create an instance of ConfigInterfacesVlan from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesVlan.parse_obj(obj)

        _obj = ConfigInterfacesVlan.parse_obj({
