...
class ConfigInterfacesEthernetRoute(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigInterfacesEthernetRoute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigInterfacesEthernetRoute:
        """Create an instance of ConfigInterfacesEthernetRoute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigInterfacesEthernetRoute.parse_obj(obj)

        _obj = ConfigInterfacesEthernetRoute.parse_obj({
