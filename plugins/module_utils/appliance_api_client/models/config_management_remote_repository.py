...
class ConfigManagementRemoteRepository(BaseModel):
    ...
    repository_type: Optional[StrictStr] = Field(default=None, description="The type of remote repository used for storing the software packages.")
    __properties: ClassVar[List[str]] = ["cloudsmith", "repository_type"]
