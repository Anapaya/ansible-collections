...
class ConfigInterfacesEthernet(BaseModel):
    ...
    driver: Optional[StrictStr] = Field(default=None, description="The driver which should be used for the interface.")
    ...
    neighbors: Optional[List[ConfigInterfacesEthernetNeighbor]] = Field(default=None, description="The static neighbors configured on this network interface.")
    routes: Optional[List[ConfigInterfacesEthernetRoute]] = Field(default=None, description="The routes which are configured on this network interface.")
    ...
    vrrp: Optional[List[ConfigInterfacesEthernetVrrp]] = Field(default=None, description="The VRRP (Virtual Router Redundancy Protocol) configurations for this interface.")
    __properties: ClassVar[List[str]] = ["accept_ra", "addresses", "driver", "gateway", "mac", "mtu", "name", "neighbors", "routes", "rx_queue_size", "tx_queue_size", "vpp", "vrrp"]
