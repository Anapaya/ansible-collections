...
class TestScionTunnelingSGRPDomains(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScionTunnelingSGRPDomains:
        """Test ScionTunnelingSGRPDomains
        ...
        if include_optional:
            return ScionTunnelingSGRPDomains(
                domains = {
                    'key' : ansible.module_utils.appliance_api_client.models.scion_tunneling_sgrp_domain.ScionTunnelingSGRPDomain(
                        announced = [
                            ''
                            ], 
                        received = [
    ...
    def testScionTunnelingSGRPDomains(self):
        """Test ScionTunnelingSGRPDomains"""
